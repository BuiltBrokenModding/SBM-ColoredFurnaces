...
public class GuiColoredFurnace extends GuiContainer
{
    ...
    private final TileEntityColoredFurnace tileFurnace;

    public GuiColoredFurnace(InventoryPlayer playerInv, TileEntityColoredFurnace furnaceInv)
    {
        super(new ContainerColoredFurnace(playerInv, furnaceInv));
